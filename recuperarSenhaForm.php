...
<body class="bg">
	...
	<div id="corpo">
    <div id="campoLogin">
        <form action="recuperarSenha.php" method="post" name="formRecSenha">
        <div class="row">
                  <div class="input-field col s12">
                      <input id="email" type="email" class="validate" placeholder="Seu email" name="email" required>
                      <label for="email" ></label>
                  </div>
                </div>
                <button class="btn waves-effect waves-light"  id="botaoEntrar" type="submit" name="enviar">Recuperar Senha</button>
        </form>
    </div>
	</div>
