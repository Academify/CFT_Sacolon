...
<body class="bg">
	...
	<div id="corpo">
		...
		<div class="campoMeuKit">
			<h1 class="tituloTexto" id="tituloCadastro">Kit Semanal</h1>
			<table id="tabelaProdutosKit">
				  	<tr>
		  			...
		  			<tr>
		    			...
		    			<td><input TYPE="image" SRC="css/img/iconeExcluir.png" NAME="iconeExcluir" id="iconeExcluir" onClick="window.location.href='meuKit.php'"></td>
		  			</tr>
		  			<tr>
		    			<td id="nomeItem"> Alface Americana</td>
		   				<td id="qtdItem">2</td>
		  			...
		  			<tr>
		    			...
		    			<td id="precoUniItem">R$0.99</td>
		    			<td id="precoTotalItem">R$1.98</td>
		    			<td><input TYPE="image" SRC="css/img/iconeExcluir.png" NAME="iconeExcluir" id="iconeExcluir" onClick="window.location.href='minhaCesta.php'"></td>
		  			</tr>

			</table>
			<button class="btn waves-effect waves-light"  id="botaoAddProduto" name="action">Adicionar Produto</button>
			<button class="btn waves-effect waves-light"  id="botaoLimparKit" name="action">Limpar Kit</button>
			<button class="btn waves-effect waves-light"  id="botaoExcluirKit" name="action">Excluir Kit</button>
			<button class="btn waves-effect waves-light"  id="botaoSalvarKit" name="action">Salvar</button>
		...
		<div id="campoCliente">
			...
			<ul class="collection" id="listaKits">
		        ...
		        <li class="collection-item" id="kitLista"><div>Kit Maionese<a href="meuKit.hmtl" class="secondary-content"><i class="material-icons" id="txtKit">Info</i></a><br><a href="#!" class="secondary-content"><i class="material-icons" id="txtKit">por na cesta</i></a></div></li>
